          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                img: "/images/lab-scientist1.jpeg",
                imgAlt: "CKS Hospital Kimuka laboratory",
                items: [
                  "Hypertension and diabetes monitoring",
                  "Pregnancy and reproductive health tests",
                  "Thyroid and hormone profile tests",
                  "Cancer screening tests",
                  "Serological tests (HBsAg, HCV, H.pylori, BAT, RF etc.)",
                  "Lipid profile test",
                  "Liver function tests",
                  "Renal function (Creatine, GFR) tests",
                  "Full blood count",
