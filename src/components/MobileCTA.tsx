...
const PhoneIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013 5.18 2 2 0 015 3h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L9.91 10a16 16 0 006.09 6.09l.75-.75a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z" />
  </svg>
);
    ...
    <>
      ...
      <nav className="thumb-nav md:hidden" aria-label="Quick actions">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="thumb-nav-item thumb-nav-wa"
          aria-label="WhatsApp"
        >
          <WaIcon />
          <span>WhatsApp</span>
        </a>
        <a href={`tel:${phone}`} className="thumb-nav-item thumb-nav-call" aria-label="Call us">
          <PhoneIcon />
          <span>Call</span>
        </a>
      </nav>
